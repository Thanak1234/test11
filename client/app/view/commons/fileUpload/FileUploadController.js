/* global Ext */
Ext.define('UI.view.common.fileUpload.FileUploadController', {
    ...
    viewFile: function(grid, record, tr, rowIndex, e, eOpts ) {          
        ...
        var window = Ext.create('UI.view.common.fileUpload.FileUploadWindow', 
         {mainView: me,
         viewModel: {
            data: {
                action: 'VIEW',
    ...
    addNewFile: function(){
        var me=this,
            window = Ext.create('UI.view.common.fileUpload.FileUploadWindow',
                {
                    mainView: me,
                    viewModel: {
                        data: {
