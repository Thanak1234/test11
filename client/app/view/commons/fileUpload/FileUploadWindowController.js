Ext.define('UI.view.common.fileUpload.FileUploadWindowController', {
    ...
    onUploadClicked: function () {
        ...
        if (form.isValid()) {
            ...
            me.uploadFile(form.url, formData, function(req) {
                var attachment = JSON.parse(req.responseText);
                attachment.isTemp = true;
                view.cbFn(Ext.create('UI.model.common.FileUpload', attachment));
                form.reset();
            });
        }
    },
