...
Ext.define('UI.view.xComponents.DateTimePicker', {
    ...
    updateSliders: function() {
        ...
        if (me.timePicker.rendered) {
            if (currentDate instanceof Date && isFinite(currentDate)) {
...
Ext.define('UI.view.xComponents.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.datetime',
    alwaysOnTop: true,
    requires: ['UI.view.xComponents.DateTimePicker'],
    ...
    createPicker: function() {
        ...
        return Ext.create('UI.view.xComponents.DateTimePicker', Ext.merge(initialConfig, parentConfig));
    },
